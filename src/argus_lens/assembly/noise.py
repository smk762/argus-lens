...
TRAINING_NOISE_TAGS: frozenset[str] = frozenset({
    "sensitive", "general", "questionable", "explicit",
    "rating:general", "rating:sensitive", "rating:questionable", "rating:explicit",
    "realistic", "1girl", "1boy", "1other", "solo",
})
...
IDENTITY_REDUNDANT_TAGS: frozenset[str] = frozenset({
    "brown_hair", "brown_eyes", "black_hair", "black_eyes",
    "blonde_hair", "blue_eyes", "green_eyes", "red_hair",
    "long_hair", "short_hair", "medium_hair",
    "male", "female", "breasts", "medium_breasts",
})
